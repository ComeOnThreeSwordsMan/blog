...
import com.acfun.common.validator.constraintvalidators.PasswordValidator;
...
public @interface Password {
     ...
     * @return
     */
    String message() default "{com.servingcloud.vscloud.common.validator.constraints.Password.message}";
