...
import com.acfun.common.validator.constraintvalidators.CodeValidator;
...
public @interface Code {
     ...
     * @return
     */
    String message() default "{com.servingcloud.vscloud.common.validator.constraints.Code.message}";
